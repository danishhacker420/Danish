...
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
     ...
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m ANISH X ABHAY KI MA KA BOSDA
...
def apvdef():
    ...
    y="".join(a)
    key=f"DANISH|{y}|HKR"
    row=httpx.get("https://raw.githubusercontent.com/danishhacker420/database/main/hkr.txt").text
    if key in row:
        main()
    else:
        os.system("clear")
        ...
        print(" Your key :"+key)
        os.system("termux-open https://wa.link/xhsk49")
        sys.exit 
